...
var FullCalendar = (function (e) {
	...
	function Je(e) {
		(e.style.userSelect = "none"),
			...
			e.addEventListener("selectstart", Le);
	}
	function Ke(e) {
		(e.style.userSelect = ""),
			(e.style.webkitUserSelect = ""),
			e.removeEventListener("selectstart", Le);
	}
	function et(e) {
	...
	class qn extends Gn {
		constructor() {
			super(...arguments),
				...
				(this.handleEl = (e) => {
					Yn(this.props.generatorName, this.context.options) ||
						this.updateElRef(e);
				}),
				(this.updateElRef = (e) => {
	...
	function Yr(e, t, n) {
		n.emitter.trigger(
			"select",
			Object.assign(Object.assign({}, Zr(e, n)), {
	...
	function Kr(e, t, n, r, i) {
		...
		return (
			...
			l.range.end < l.range.start &&
				(l.range.end = Xr(t.allDay, l.range.start, i)),
			l
		);
	}
	class ei {
	...
	class ti {
		...
		get source() {
			...
			return e
				? new ei(this._context, this._context.getCurrentData().eventSources[e])
				: null;
		}
		get start() {
	...
	class Ni {
		...
		select(e, t) {
			...
			i &&
				(this.dispatch({ type: "SELECT_DATES", selection: i }), Yr(i, null, r));
		}
		unselect(e) {
			let t = this.getCurrentData();
			t.dateSelection &&
	...
	class cs {
		...
		splitEntry(e, t, n) {
			...
			return (
				...
				r
					? (n.push(
							{ index: e.index, thickness: e.thickness, span: fs(o, s) },
							...i
					  ),
					  r)
					: (n.push(e), 0)
	...
	class Is {
		...
		_sliceBusinessHours(e, t, n, r, ...i) {
			return e
				? this._sliceEventStore(mr(e, Os(t, Boolean(n)), r), {}, t, n, ...i).bg
				: [];
		}
					...
					for (let r in l) {
						...
						for (let e in h) {
							...
							if (or(g, n.range)) {
								...
								if (y && !y(new ti(t, u[n.defId], n), new ti(t, m, o)))
									return !1;
							}
						}
						let b = i.eventStore;
						for (let e of p.allows) {
							let i,
								...
								a = b.defs[m.defId],
								l = b.instances[r];
							if (((i = a ? new ti(t, a, l) : new ti(t, m)), !e(Zr(s, t), i)))
								return !1;
						}
					}
					return !0;
	...
	class Fs extends Gn {
		...
		getXScrollbarWidth() {
			return Ls.test(this.props.overflowX)
				? 0
				: this.el.offsetHeight - this.el.clientHeight;
		}
		getYScrollbarWidth() {
			return Ls.test(this.props.overflowY)
				? 0
	...
	function Qo(e, t, n, r) {
		...
		switch (t.type) {
			...
			case "FETCH_EVENT_SOURCES":
				return Xo(
					e,
					t.sourceIds ? Dn(t.sourceIds) : Jo(e, r),
					i,
					t.isRefetch || !1,
					r
				);
			...
			if (a && a !== l) {
				a.timeZone !== l.timeZone &&
					...
					(t.eventStore = s.eventStore =
						Fr(s.eventStore, n.dateEnv, s.dateEnv)),
					(t.renderableEventStore = s.renderableEventStore =
						Fr(s.renderableEventStore, n.dateEnv, s.dateEnv)));
				for (let e in o)
	...
	class Va {
		constructor(e) {
			(this.origRect = ts(e)),
				(this.scrollCaches = ns(e).map((e) => new za(e, !0)));
		}
		destroy() {
			for (let e of this.scrollCaches) e.destroy();
		}
		...
		isWithinClipping(e, t) {
			...
			for (let e of this.scrollCaches)
				if (!Ga(e.getEventTarget()) && !Pi(n, e.clientRect)) return !1;
			return !0;
		}
	}
	function Ga(e) {
					...
					if (e) {
						...
						i === s || (t.editable && t.droppable)
							? ((o = (function (e, t, n) {
							  ...
							  o &&
									((a = $r(n, s.getCurrentData().eventUiBases, o, s)),
									(c.mutatedEvents = a),
									Ns(c, e.dateProfile, s) ||
										((l = !0),
										(o = null),
										(a = null),
			...
			class extends Mi {
				constructor(e) {
					super(e),
						...
						(this.handlePointerUp = (e) => {
							this.dragSelection &&
								(Yr(this.dragSelection, e, this.component.context),
								(this.dragSelection = null));
						});
					let { component: t } = e,
						{ options: n } = t.context,
				...
				constructor(e) {
					super(e),
						...
						(this.handleHitUpdate = (e, t, n) => {
							...
							a &&
								((l = $r(i, r.getCurrentData().eventUiBases, a, r)),
								(d.mutatedEvents = l),
								Ns(d, e.dateProfile, r) ||
				...
				for (let o of e) {
					...
					s.push(
						p(
							...
							"bg-event" === t
								? p(go, Object.assign({ seg: o }, mi(o, r)))
								: mo(t)
						)
					);
				}
					...
					(r, i) => {
						...
						return p(
							...
							"bg-event" === t
								? p(
										go,
										Object.assign({ seg: s }, mi(s, n.todayRange, n.nowDate))
								  )
								: mo(t)
						);
					}
