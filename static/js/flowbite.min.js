	...
	return (function () {
		...
		var t = {
				...
				853: function (t, e, i) {
					...
					function mt(t, e) {
						...
						var i = e,
							...
							x = t.elements[w ? A : b],
							T = gt(
								C(x) ? x : x.contextElement || K(t.elements.popper),
								g,
								m,
								d
							),
							...
							if (O) {
								if (d) {
									var M,
										...
										nt = G(0, x[R], Q[R]),
										ot = I
											? x[R] / 2 - N - nt - et - P.mainAxis
											: U - nt - et - P.mainAxis,
										rt = I
											? -x[R] / 2 + N + nt + it + P.mainAxis
											: $ + nt + it + P.mainAxis,
				...
				316: function (t, e, i) {
					...
					(e.initDropdowns = d),
						"undefined" != typeof window &&
							((window.Dropdown = l), (window.initDropdowns = d)),
						(e.default = l);
				},
				311: function (t, e, i) {
					Object.defineProperty(e, "__esModule", { value: !0 }),
					...
					(e.initFlowbite = v),
						"undefined" != typeof window && (window.initFlowbite = v);
				},
				656: function (t, e, i) {
					var n =
						(this && this.__assign) ||
				...
				903: function (t, e, i) {
					...
					(e.initPopovers = d),
						"undefined" != typeof window &&
							((window.Popover = l), (window.initPopovers = d)),
						(e.default = l);
				},
				247: function (t, e, i) {
					var n =
				...
				671: function (t, e, i) {
					...
					(e.initTooltips = d),
						"undefined" != typeof window &&
							((window.Tooltip = l), (window.initTooltips = d)),
						(e.default = l);
				},
				947: function (t, e) {
					Object.defineProperty(e, "__esModule", { value: !0 });
